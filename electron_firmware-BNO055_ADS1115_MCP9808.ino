...
int norm_smpl_intvl = 110;      // SAMPLE INTERVAL, HOW MANY SECONDS TO WAIT BETWEEN EACH
const int rnds_to_publish = 12; // WAIT UNTIL x NUMBER OF SAMPLES ARE GATHERED TO BURST PUBLISH
...
// ALAERT SETTING //
int alert_smpl_intvl = 45;                                                     // ALERT SAMPLE INTERVAL, HOW MANY SECONDS TO WAIT BETWEEN EACH
const int alrt_publish_rnds = 2;                                               // WHILE IN SENSOR ALERT - HOW MANY COMPLETE PUBLISH CYCLES TO LOOP THROUGH
int sensor_alert_thrshld[no_of_sensors] = {999, 999, 999, 999, 2, 90, 15, 15}; // SET ARRAY FOR SENSOR ALERT
...
void loop()
{
  ...
  //will cause is loss of 'x' orination
  if (resetct == 0)
  {
